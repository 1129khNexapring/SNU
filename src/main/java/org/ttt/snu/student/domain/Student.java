...
public class Student {
	...
	public String toString() {
		return "Student [학번=" + sCode + ", 이름=" + sName + ", 주민번호=" + sRrn + ", 비밀번호=" + sPassword + ", 주소=" + sAddress
				+ ", 이메일=" + sEmail + ", 성별=" + sGender + ", 휴대폰번호=" + sPhone + ", 입학일=" + sAddmission + ", 출석여부="
				+ absenceYN + ", 전과여부=" + transferYN + ", 학과코드=" + dCode + "]";
	};
